...
export default function YouTubeWatchLink({ videoId, timestamp, revealClassName = '' }: {
  ...
  return (
    <a
      ...
      className={`${revealClassName} transition-[opacity,transform] transform hover:scale-110 text-token-secondary hover:text-[#FF0000] bg-surface p-token-2 rounded-radius-circle`.trim()}
      style={{
