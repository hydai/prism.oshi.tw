...
// Active tags in catalog order, grouped by category. Categories with nothing to offer are
// dropped so pickers and filters never render an empty group.
export function activeTagsByCategory(): TagCategoryGroup[] {
